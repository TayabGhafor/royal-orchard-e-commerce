...
const ShippingPolicy = () => (
  <SiteShell>
    <header className="relative min-h-[680px] flex items-center overflow-hidden bg-inverse-surface">
      <img
    ...
    <main className="mx-auto max-w-7xl space-y-32 px-8 py-24">
      <section className="grid grid-cols-1 items-center gap-16 lg:grid-cols-12">
      ...
      <section className="grid grid-cols-1 overflow-hidden rounded-lg bg-surface-variant md:grid-cols-2 md:gap-px">
